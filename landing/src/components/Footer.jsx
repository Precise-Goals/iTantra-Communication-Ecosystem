  ...
  const sitemapColumns = [
    {
      ...
      links: [
        ...
        { label: 'Mesh Transceiver', href: '#range-architecture' },
        { label: 'Range Architecture', href: '#range-architecture' },
    ...
    },
    {
      ...
      links: [
        ...
        { label: 'P2P Radio Mesh', href: '#range-architecture' },
    ...
    },
    {
      ...
      links: [
        ...
        { label: 'Range Gap Analysis', href: '#range-architecture' },
