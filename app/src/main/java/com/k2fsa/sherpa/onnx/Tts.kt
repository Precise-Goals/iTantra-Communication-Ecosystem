...
//
// Vendored verbatim from k2-fsa/sherpa-onnx (Apache 2.0), tag v1.13.7:
// https://github.com/k2-fsa/sherpa-onnx/blob/v1.13.7/sherpa-onnx/kotlin-api/Tts.kt
// This is the documented integration pattern: the AAR (app/libs/) ships the native
// libsherpa-onnx-jni.so; this thin Kotlin wrapper is meant to be copied into the
// consuming app rather than published as a separate artifact. Do not hand-edit the
// `external fun` declarations below — they must match the native library's JNI exactly.
